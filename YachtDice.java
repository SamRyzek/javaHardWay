public class YachtDice
{
	...
	{
		int r1, r2, r3, r4, r5, r6; //added r6
		boolean allSame;
		...
		do
		{
			...
			r6 = 1 + (int)(Math.random()*6); //added r6
			System.out.print("\nYou rolled: " + r1 + " " + r2 + " ");
			System.out.println(r3 + " " + r4 + " " + r5 + " " + r6); //added r6
			showDice(r1);
			showDice(r2);
			showDice(r3);
			showDice(r4);
			showDice(r5);
			showDice(r6); //added r6
			
			allSame = (r1 == r2 && r2 == r3 && r3 == r4 && r4 == r5 && r5 == r6); //added r6
		}
		while ( ! allSame);
